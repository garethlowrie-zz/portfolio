      ...
      <Flex direction="column">
        ...
        <SidebarSection header="ABOUT" icon={download}>
          <SidebarItem
            ...
            linkProps={{
              href:
                "https://github.com/garethlowrie/portfolio/raw/master/src/assets/Gareth%20Lowrie%20Resume.pdf",
              target: "_blank"
            }}
        ...
        <SidebarSection header="CONTACT" icon={phone}>
          <SidebarItem
            icon={email}
            linkProps={{ href: "mailto:gareth@geordie.dev" }}
            linkText="GARETH@GEORDIE.DEV"
            label="Email me"
          />
          <SidebarItem
            icon={phone}
